...
//this is where the area is added
...
//this is where the line is added
  ...
  //this is where the circle is added
  // _appendCircle: function(g) {
  //   //debugger;
  //   //this._appendLine = this._areapath.datum(this._data).append("circle")
  //    g.selectAll("circle")
  //    g.append("path").data(this._data)
  //     //.append("g")
  ...
  //
  //     //console.log('test', this._areapath.datum(this._data))
  // },
...
//shows values on the graph alt and dist
...
// L.control.elevation = function(container) {
//
//   return L.Control.Elevation(container);
//   console.log('test', L.Control.Elevation(container))
// };
// var test = L.Control.Elevation.addData
// console.log(test)
/*
 * Copyright (c) 2019, GPL-3.0+ Project, Raruto
 *
